...
<div class="container register_wrap bgwhite">
  <div class="register_head clearfix">
    ...
    <a class="pull-right" href="<%=request.getContextPath() %>/login/pcForgotPasswordMail.do">邮箱找回</a>
  </div>
  ...
  <div class="findpwd-con">
    <form id="form">
    	<input type="hidden" id="paramType" name="paramType" value="0" />
      <div class="form-group">
        <label for="name" class="control-label col-sm-4">手机号码：</label>
        <div class="col-sm-8">
          <input type="text" class="form-control" id="account" name="account" placeholder="请输入手机号码">
         <p id="accountText"></p>
        </div>
      </div>
      <div class="form-group ">
