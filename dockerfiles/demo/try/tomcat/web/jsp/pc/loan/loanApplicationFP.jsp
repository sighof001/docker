...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/pcjs/pc/loan/loanApplicationFP.js"></script>
<script>
...
<body>
	...
	<!------贷款内容start------->
	<div class="container martop30 bgwhite clearfix submit-group-wrap">
		<ul class="synewsNavUl loanapplication_NavUl tabsNavUl  clearfix">
			<li class="synewsNavOn tabNavOn">扶贫贷款申请</li>
			<!-- <li>公司贷款申请(扶贫)</li> -->
		</ul>
		<div class=" loanapplication_con tab_content">
			<!--个人贷款start--->
			<div class=" tab_item">
				<form class="form-horizontal" role="form" id="person">
					<%-- <c:if test="${isRealAuth==false &&isFP==true}">
					...
					<c:if test="${isFP==false }">
						<div class="form-group">
							<p style="font-size: 20px;" align="center">您不是扶贫用户,暂不能申请扶贫贷款</p>
						</div>
					</c:if> --%>
					<div class="form-group">
						<label class="col-sm-2 control-label">贷款城市:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control submit-group" placeholder="广州" disabled>
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-6">
							<%-- <c:if test="${isRealAuth==false||isFP==false }">
								<button type="button" disabled="disabled"
									class="btn btn-default btnorange register_btn"
									id="personSubmit">确认贷款</button>
							</c:if>
							<c:if test="${isRealAuth==true&&isFP==true }">
								<button type="button"
									class="btn btn-default btnorange register_btn"
									id="personSubmit">确认贷款</button>
							</c:if> --%>
							<button type="button"
									class="btn btn-default btnorange register_btn submit-group"
									id="personSubmit">确认贷款</button>
						</div>
					</div>
				</form>
			...
			<div class=" tab_item">
				<form class="form-horizontal" role="form" id="company">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="请输入公司注册地址"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="请输入公司办公地址"
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">拟借金额:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="请输入拟借金额"
								id="amountCompany" name="amount">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">借款用途:</label>
						<div class="col-sm-10">
							<select class="form-control" id="loanUseCompany" name="loanUse">
								<option value="">请选择</option>
								<c:forEach items="${loanUseType}" var="item">
									<option value="${item.dictValue}">${item.text}</option>
								</c:forEach>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">借款期限(天):</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="请输入借款期限"
								id="loanTermCompany" name="loanTerm">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">还款来源:</label>
						<div class="col-sm-10">
							<select class="form-control" id="repaymentSourceCompany"
								name="repaymentSource">
								<option value="">请选择</option>
								<c:forEach items="${repaymentSourceType}" var="item">
									<option value="${item.dictValue}">${item.text}</option>
					...
					<div class="form-group">
						...
						<div class="valid_wrap clearfix col-sm-10">
							<input type="text" class="form-control pull-left "
								id="checkCodeCompany" name="checkCode" placeholder="请输入验证码">
							<img
								src="<%=request.getContextPath()%>/login/getCode.do?imgHeight=96&imgWidth=34&codeLen=4"
								class=" pull-left" id="loginCodeImgCompany"
