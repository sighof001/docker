...
<div data-role="page" id="pageone" class="page"  data-theme="i"> 
  ...
  <div class="tab_item">
  <form id="person_form">
   <input id="loanType" type="hidden" name="loanType" value="3"/>
   ...
   <li>
	   <label>联系电话</label>
	   <input type="tel" id="tel" name="telText" class="inputtxt inputtxt2" placeholder="请输入联系电话" data-role="none" value="${currentUser.mobile }" disabled="disabled"/>
	   <input type="hidden"  name="tel" class="inputtxt inputtxt2"  data-role="none" value="${currentUser.mobile }"/>
	    <div class="pop_tip" id="telText">
	      <p></p>
	      <p class="pop_tip_arrow">&diams;</p>
	    </div>
   </li>
    ...
    <li>
     ...
     <li>
     	<label>拟借金额</label>
     	<input type="number"  id="person_amount" name="amount"  placeholder="请输入拟借金额 (单位:元)"  class="inputtxt"  data-role="none"/>
   	...
   	<li>
     	<label>借款期限</label>
     	<input type="number" id="person_loanTerm" name="loanTerm"  placeholder="请输入借款期限 (单位:天)"  class="inputtxt"  data-role="none"/>
   ...
   <li>
     ...
     <p class="errorInfo" style="color:red;"></p>
   </ul>
   <input type="button"  class="btn" id="person_submit"  data-role="none" value="立即申请"/>
   </form>
  </div>
  <!------个人贷款申请end----->
  ...
  <form id="enterprise_form">
   <input id="loanType" type="hidden" name="loanType" value="4"/>
   <ul class="ul-formlist form-list">
   <li>
   		<label>贷款城市</label>
   		<input type="text" id="txt_city"  placeholder="目前开放广州的个人借贷业务" disabled="disabled"  class="citytxt"  data-role="none"/>
		<input type="hidden" id="hd_city"  data-role="none"/>
   </li>
   ...
   <li>
   		<label>联系电话</label>
   		<input type="tel" id="enterprise_telText" name="telText" class="inputtxt inputtxt2" placeholder="请输入联系电话" data-role="none" value="${currentUser.mobile }" disabled="disabled"/>
   ...
   <li>
    ...
    <li>
    	<label>拟借金额</label>
    	<input type="number" id="enterprise_amount" name="amount"  placeholder="请输入拟借金额"  class="inputtxt"  data-role="none"/>
   ...
   <li>
     	<label>借款期限</label>
     	<input type="number" id="enterprise_loanTerm" name="loanTerm"  placeholder="请输入借款期限"  class="inputtxt"  data-role="none"/>
   ...
   <input type="button" id="enterprise_submit"  class="btn" data-role="none" value="立即申请"/>
   </form>
  </div>
  <!--------企业贷款申请end-------->
   </div>
