...
<script
	src="<%=request.getContextPath()%>/js/mobile/cust/custMailAddress.js">
			...
			<div>
				<div class="wrap">
					<form id="form">
						...
						<ul class="form-list">
							<li><label>邮寄地址</label> <input id="mailAddress" name="mailAddress"
								type="text" data-role="none" class="inputtxt"
								value="${tryCustInfo.mailAddress}" autofocus /></li>
							<!--错误提示，默认隐藏 -->
