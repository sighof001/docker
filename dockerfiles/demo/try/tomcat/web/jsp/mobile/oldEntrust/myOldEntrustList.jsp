...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/mobile/oldEntrust/myOldEntrustList.js"></script>
<script type="text/javascript">
var type = '${type}';
</script>
<style type="text/css">
	...
	<div data-role="page" id="pageone" class="page" data-theme="i">
		...
		<div class="inside-main data-container content">
			<div class="selectNavUl ui-grid-c clearfix">
			    ...
			    <a class="entrust-block" id="no" onclick="turnPage(0)" >存续期</a>
			    <a class="entrust-block" id="yes" onclick="turnPage(1)" >已转出</a>
		    </div>
			<div class=" lists"></div>
		</div>
	</div>
