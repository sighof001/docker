  ...
  <!----委托头部 start--->
    ...
    <div class="ui-grid-a delegatedetail-toplink"> 
     <div class="ui-block-a">
      ...
      <div class="product-sum-topcon delegatedetail-sum-topcon">
        ...
        <p class="f48 fb">${order.amount }<span class="size-small">元</span></p>
      </div>
    </div>
    <!---委托头部 end--->
    <!----委托头部收益 start----->
    ...
    <div class="inside-list"> 
     <%-- <a class="inside-listcon clearfix" >
      ...
      <div class="fr list-info color-grey">${order.endDateText }</div>
      </a> --%>
       <a class="inside-listcon clearfix" >
      <div class="fl list-title">委托时间</div>
      <div class="fr list-info color-grey">${order.beginDateText }</div>
      </a> 
       <!-- <a class="inside-listcon clearfix" >
...
<%--  <a class="inside-listcon clearfix" href="<%=request.getContextPath() %>/webEntrust/policyView/${order.id}.do" rel="external"> --%>
      ...
      <div class="fl list-title">查看委托合同</div>
      <div class="fr list-info color-grey icon-rightarrow-1"></div>
      </a> --> 
      </div>
    <!-----一个产品信息 end---->
...
<%--     <div class="ui-grid-a f24 delegatedetail-footerbtn">
      ...
      <c:if test="${order.assetStatus != '3' }">
	      <a class="ui-block-b extract" href="<%=request.getContextPath()%>/webEntrust/extract/${order.id}.do" rel="external">
	      	 转出
	      </a>
      </c:if>
      <c:if test="${order.assetStatus == '3' }">
