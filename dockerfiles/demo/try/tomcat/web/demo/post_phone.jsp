<%@ page contentType="text/html; charset=UTF-8" language="java" pageEncoding="UTF-8" import=" com.allinpay.ets.client.*" errorPage="" %>
	...
	<center>
	<!--================= post 方式提交支付请求 start =====================-->
    <!--================= 测试地址为测试环境：http://ceshi.allinpay.com /mobilepayment/mobile/SaveMchtOrderServlet.action 
    生产环境：https://service.allinpay.com /mobilepayment/mobile/SaveMchtOrderServlet.action  =====================-->
