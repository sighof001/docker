...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/trySysConfig/trySysConfigList.js"></script>
	...
	<div class="panel panel-default no-border">
		<div class="panel-heading">
			...
			<ul class="query-form-wrap form-wrap">
						<li><span class="form_span">键名称：</span>
							<input id="keyName" name="keyName" type="text" class="form-control" placeholder="" />
						</li>
						</ul>
