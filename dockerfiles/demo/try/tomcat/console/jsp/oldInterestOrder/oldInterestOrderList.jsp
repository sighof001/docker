...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/oldInterestOrder/oldInterestOrderList.js"></script>
...
<body>
	<div class="panel panel-default no-border">
		<div class="panel-heading">
			<div id="query-form" class="query-form">
				<ul class="query-form-wrap form-wrap">
					...
					<li><span class="form_span">时间开始：</span> <input
						id="queryBeignTradeDate" name="queryBeignTradeDate" type="text"
						data-type="datetime"
						onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" placeholder="时间开始">
					</li>
					<li><span class="form_span">时间结束：</span> <input
						id="queryEndTradeDate" name="queryEndTradeDate" type="text"
						data-type="datetime"
						onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" placeholder="时间结束">
					</li>
				</ul>
        ...
        <div class="content_title">
            <div class="titleName">历史付息列表</div>
