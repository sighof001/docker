...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/tryOrder/tryPaymentEdit.js"></script>
		...
		<div class="panel-body floating-content">
			<form id="edit-form" name="edit-form" class="row" onSubmit="return false">
				...
				<ul class="form-wrap formgroup_wrap">
					...
					<li>
						<span class="form_span" title="返息金额">返息金额(元):</span>
					...
					<li>
						...
						<input type="text" class="form-control" id="payTime" name="payTime"  value="${tryOrder.payTimeStr}" placeholder="请输入支付时间"/>
