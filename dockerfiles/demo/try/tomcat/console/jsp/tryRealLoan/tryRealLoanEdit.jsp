...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/tryRealLoan/tryRealLoanEdit.js"></script>
			...
			<form id="edit-form" name="edit-form" class="row" onSubmit="return false">
				...
				<ul class="form-wrap formgroup_wrap">
					...
					<%-- <li>
						...
						<input type="text" class="form-control" id="paybackDate" name="paybackDate"  value="${tryRealLoan.paybackDate}" placeholder="请输入还款日期"/>
