...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/oldEntrustOrder/oldEntrustOrderInterest.js"></script>
			...
			<form id="edit-form" name="edit-form" class="row" onSubmit="return false">
				...
				<ul class="form-wrap formgroup_wrap">
					<li>
						...
						<input type="text" class="form-control" id="amount" name="amount"  placeholder="请输入付息金额"/>
						<p id='amountTip' class="form_tips formalert"></p>
					</li>
					<li>
						<span class="form_span" title="付息时间">付息时间:</span>
						<input id="tradeDate" name="tradeDate" type="text"
						data-type="datetime"
						onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" placeholder="付息时间">
						<p id='tradeDateTip' class="form_tips formalert"></p>
					</li>
					</ul>
					<ul class="form-wrap formgroup_wrap">
					<li class="textarea">
