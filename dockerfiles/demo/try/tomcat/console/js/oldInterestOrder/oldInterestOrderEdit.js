...
function returnPage(){
	var r = cxt + '/oldInterestOrder/oldInterestOrderList.do';
	if(returnType == '1'){
...
function initValidator(){
	var formUrl = '';
	if(op == const_op_add){
		formUrl = cxt + "/oldInterestOrder/addOldInterestOrder.do";
	}else if(op == const_op_update){
		formUrl = cxt + "/oldInterestOrder/updateOldInterestOrder.do";
	}
