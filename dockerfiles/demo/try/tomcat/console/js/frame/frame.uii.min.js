...
+function($){
    ...
    Tab.prototype = {
        ...
        add: function(options){
            ...
            this.getTabPanel().find("a[href=#" + id + "]").closest("li").find("i.icon-remove").on("click", this.remove);
            var content_html = [];
        ...
        var f = null;
        this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.tab"), options = typeof option == "object" && option;
            if (!data) {
        ...
        return f
    }, $.fn.frame.ui.tab = {}, $.fn.frame.ui.tab.Constructor = Tab, $.fn.frame.ui.tab.defaults = {
        "show_close_btn": true,
        max_tabs: 8
    }
}(jQuery);
+function($){
    var TabMenu = function(element, options){
        this.$element = $(element);
        this.options = $.extend({}, $.fn.frame.ui.tabmenu.defaults, options);
        this.init(element, options)
    };
    TabMenu.prototype = {
        constructor: TabMenu,
        ...
        getOptions: function(options){
            options = $.extend({}, $.fn.frame.ui.tabmenu.defaults, options, this.$element.data());
            return options
        },
        create: function(){
        ...
        initEvent: function(parent){
            ...
            if (hasEvent(this.$element, "click")) {
                return false
            }
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.tabmenu"), options = typeof option == "object" && option;
            if (!data && options) {
    ...
    }, $.fn.frame.ui.tabmenu = {}, $.fn.frame.ui.tabmenu.Constructor = TabMenu, $.fn.frame.ui.tabmenu.defaults = {
        clickHandler: null
    }
}(jQuery);
+function($){
    var Table = function(element, options){
        this.$element = $(element);
        this.options = $.extend({}, $.fn.frame.ui.table.defaults, options);
        this.init(element, options)
    };
    Table.prototype = {
        constructor: Table,
        ...
        getOptions: function(options){
            options = $.extend({}, $.fn.frame.ui.table.defaults, options, this.$element.data());
            return options
        },
        create: function(){
            var html = [];
            ...
            $("#page-size option[value=" + this.options.pageSize + "]", this.$element).prop("selected", true);
            this.initEvent();
        ...
        createPagePanel: function(){
            ...
            html.push("每页显示 ");
			html.push('<select id="page-size"><option value=200>200</option>')
//            html.push('<select id="page-size"><option value=5>5</option><option value=10000 selected>10000</option>');
...
//            html.push("<option value=40>40</option><option value=50>50</option></select>");
        ...
        initData: function(params){
            if (this.options.datatype == "local") {
                var data = params ? (params.data && params.data.length ? params.data : []) : (this.options.data && this.options.data.length ? this.options.data : []);
                this.fillData(data)
            }
            else {
                if (this.options.datatype == "server") {
                    this.fillDataFromServer()
                }
            }
        },
        createHeader: function(){
            if (!(this.options.columns && this.options.columns.length && this.options.columns.length > 0)) {
                return
            }
            var html = [];
            html.push("<tr>");
        ...
        fillDataFromServer: function(){
            if (!(this.options.rowsurl != "" && this.options.url != "")) {
                return
            }
            this.initPage();
            ...
            function sortEvent(el){
                if (el.closest("th").length == 1) {
                    ...
                    i.closest("tr").find("i").each(function(){
                        if ($(this).closest("th").attr("name") == i.closest("th").attr("name")) {
                            return
                        }
        ...
        getNextPages: function(){
            ...
            if ((tmp * this.getPageSize()) > maxrows) {
                return
            }
            this.cur_page = tmp + 1;
            this.fillDataFromServer()
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.table"), options = typeof option == "object" && option;
            if (!data && options) {
    ...
    }, $.fn.frame.ui.table = {}, $.fn.frame.ui.table.Constructor = Table, $.fn.frame.ui.table.defaults = {
        columns: [],
        datatype: "local",
        data: [],
        op: [],
...
+function($){
    $.fn.frametree = function(options, param){
        ...
        this.each(function(){
            ...
            var template = '<div class="tree-folder" style="display:none;">' + '<div class="tree-folder-header">' + '<i class="' + c["close-icon"] + '"></i>' + '<div class="tree-folder-name"></div>' + "</div>" + '<div class="tree-folder-content"></div>' + '<div class="tree-loader" style="display:none"></div>' + "</div>" + '<div class="tree-item" style="display:none;">' + (c["unselected-icon"] == null ? "" : '<i class="' + c["unselected-icon"] + '"></i>') + '<div class="tree-item-name"></div></div>';
        ...
        return f
    }, $.fn.frame.ui.tree = {}, $.fn.frame.ui.tree.defaults = {
        ...
        "folder-icon-close": "icon-folder-close",
        "folder-icon-open": "icon-folder-open",
        "item-icon": "",
        "icon-color": "blue",
        clickHandler: null,
...
+function($){
    ...
    SearchList.prototype = {
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.searchlist"), options = typeof option == "object" && option;
            if (!data) {
    ...
    }, $.fn.frame.ui.searchlist = {}, $.fn.frame.ui.searchlist.Constructor = SearchList, $.fn.frame.ui.searchlist.defaults = {
        tree_height: 100,
        url: "",
        count_url: "",
        query_str_name: "text",
...
+function($){
    ...
    LogPanel.prototype = {
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.log"), options = typeof option == "object" && option;
            if (!data) {
    ...
    }, $.fn.frame.ui.log = {}, $.fn.frame.ui.log.Constructor = LogPanel, $.fn.frame.ui.log.defaults = {
...
+function($){
    ...
    Combox.prototype = {
        ...
        create: function(){
            if (this.$element.prop("tagName").toUpperCase() != "SELECT") {
                return
            }
            ...
            util.getServerData(this.url, {}, function(data){
                ...
                $.each(data, function(i, o){
                    if (o instanceof Object) {
                        html.push("<option value='" + o[valueName] + "'>");
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.combox"), options = typeof option == "object" && option;
            if (!data) {
    ...
    }, $.fn.frame.ui.combox = {}, $.fn.frame.ui.combox.Constructor = Combox, $.fn.frame.ui.combox.defaults = {
        width: "150px",
        fontSize: "14px",
        liveSearch: false,
        onload: null
...
+function($){
    ...
    DropdownTree.prototype = {
        ...
        create: function(){
            if (this.$element.prop("tagName").toUpperCase() == "INPUT") {
                ...
                if (this.$element.prop("tagName").toUpperCase() == "DIV") {
                    this.initInput()
                }
            }
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.droptree"), options = typeof option == "object" && option;
            if (!data) {
    ...
    }, $.fn.frame.ui.droptree = {}, $.fn.frame.ui.droptree.Constructor = DropdownTree, $.fn.frame.ui.droptree.defaults = {
        height: 200,
        onHidden: null
    }
}(jQuery);
+function($){
    ...
    EditTable.prototype = {
        ...
        return this.each(function(){
            var $this = $(this), data = $this.data("frame.ui.edittable"), options = typeof option == "object" && option;
            if (!data && options) {
    ...
    }, $.fn.frame.ui.edittable = {}, $.fn.frame.ui.edittable.Constructor = EditTable, $.fn.frame.ui.edittable.defaults = {
        columns: [],
        data: [],
        op: [],
        defaultClass: "table table-sort",
